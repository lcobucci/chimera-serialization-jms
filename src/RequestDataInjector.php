...
{
    public const GENERATED_ID = '_request.id';
    ...
    private function mergeData(array $data, Context $context): array
    {
        ...
        $idValue    = $attributes[DeserializationContext::ATTR_GENERATED_ID] ?? null;

        $generatedId = $idValue ? [self::GENERATED_ID => $idValue] : [];
        $routeParams = $attributes[DeserializationContext::ATTR_ROUTER_PARAMS] ?? [];
        $queryParams = $attributes[DeserializationContext::ATTR_QUERY_PARAMS] ?? [];
